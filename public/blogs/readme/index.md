...
export const GITHUB_CONFIG = {
	OWNER: process.env.NEXT_PUBLIC_GITHUB_OWNER || 'icarushuang02',
	REPO: process.env.NEXT_PUBLIC_GITHUB_REPO || 'icarusBlog',
	BRANCH: process.env.NEXT_PUBLIC_GITHUB_BRANCH || 'main',
	APP_ID: process.env.NEXT_PUBLIC_GITHUB_APP_ID || '3847693'
} as const
```
